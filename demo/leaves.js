...
export function initLeaves(gl, canvas, camera) {
    ...
    const particleParams = {
        ...
        minSize: 30,    // Minimum particle scale (World Units) for random variation.
        maxSize: 50,    // Maximum particle scale (World Units) for random variation.
        startLinVel:[0,-2,0],   // Initial linear velocity vector (vec3) applied at birth [x, y, z].
